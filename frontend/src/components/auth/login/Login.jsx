...
function Login({
  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      console.log("✅ Local login successful. Reloading application.");

      // The authenticated session is now established.
      // App.jsx will detect the authenticated session
      // after reload and transfer guest chats.
            ...
            {!modal && (
              <>
                ...
                <div className="guest-note">
                  Guest conversations are saved on this browser.
                </div>
              </>
            )}
          </>
